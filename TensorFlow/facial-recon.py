...
def main():
    ...
    #Second convolution
    W_conv2 = tf.Variable(tf.truncated_normal([5, 5, 20, 20], stddev=0.1))
    ...
    # Train method
    train_step = tf.train.RMSPropOptimizer(10e-3, decay=0.99999, momentum=0.99).minimize(cross_entropy) # tf.train.AdamOptimizer(1e-2).minimize(cross_entropy)
